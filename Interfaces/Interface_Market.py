...
class Application(tk.Tk):
    def __init__(self, filename):
        ...
        self.button_play = tk.Button(self, text="Blockchain & Mempool View", command=self.open_blockchain)
        self.button_play.pack(side=tk.LEFT, padx=5)
    ...
    def refresh(self):
        ...
        for key, value in results.items():
            self.tree.insert("", tk.END, values=(key[0], ", ".join(value['expediteur_objets_list1']), key[1], ", ".join(value['destinataire_objets_list2'])))
